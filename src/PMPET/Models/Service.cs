...
namespace PMPET.Models
{
    ...
    {   [Display(Name ="Service ID")]
        ...
        [Required]
        [StringLength(40, ErrorMessage = "Marketing description cannot be longer than 40 characters.")]
        ...
        public string FeeType { get; set; } // fixed or commission
        [Required]
        [Display(Name = "Sale % ")]
        [Range(0, 100, ErrorMessage = "Value for {0} must be between {1} and {2}.")]
        public float SaleCommission { get; set; } // e.g. 20%
        [Required]
        [Range(0, 100, ErrorMessage = "Value for {0} must be between {1} and {2}.")]
        [Display(Name = "Rent %")]
        public float RentCommision { get; set; }// e.g. 20%
