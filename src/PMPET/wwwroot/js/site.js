    ...
    if (currentStatus == "visibility: hidden") {
        switch (whichOne) {
            case 'Property':
                ...
                document.getElementById("infoPanelContainer").setAttribute("style", "border:1px;background-color:#808000;color:white;border-radius:5px;");
                document.getElementById("infoPanel").textContent = "Any property that the estate agent is marketing must be recorded thruogh this section. While being able to view the existing particulars of ";
                ...
                document.getElementById("infoPanel").textContent += "heading of each sortable information.  Please note that these column headings are in color for ease of reference.  Details section will display the full information";
            ...
            case 'Members':
                document.getElementById("infoPanel").setAttribute("style", "visibility: visible");
                document.getElementById("infoPanelContainer").setAttribute("style", "border:1px;background-color:#808000;color:white;border-radius:5px;");
                document.getElementById("infoPanel").textContent = "Individuals -vendors, buyers and viewers- who has dealings with the estate agent are all traeted as Members. Pickme Properties";
                ...
                document.getElementById("infoPanel").textContent +="heading of each column.  Please note that these column headings are in color for ease of reference.  Details section will display the full information";
            ...
            case 'Viewings':
                ...
                document.getElementById("infoPanel").textContent +="Users can also re-arrange the list of viewings by clicking the heading of each sortable information.  Please note that these column headings are";
                document.getElementById("infoPanel").textContent +="in color for ease of reference.  Details section will display the full information about any particular viewing including notes that may have been added.";
                break;
            case 'Services':
                document.getElementById("infoPanel").setAttribute("style", "visibility: visible");
                document.getElementById("infoPanelContainer").setAttribute("style", "border:1px;background-color:#808000;color:white;border-radius:5px;");
            ...
            case 'Offers':
                document.getElementById("infoPanel").setAttribute("style", "visibility: visible");
                document.getElementById("infoPanelContainer").setAttribute("style", "border:1px;background-color:#808000;color:white;border-radius:5px;");
                document.getElementById("infoPanel").textContent = "Pickme Properties needs to keep a track of offers received  (either sale or rental) for a particular propertry. While being able to browse through details";
                ...
                document.getElementById("infoPanel").textContent += "Details section will display the full information about any particular offer including any notes which may have been entered regrding the offer.";
                break;
            default:
                document.getElementById("infoPanel").setAttribute("style", "visibility: visible");
                document.getElementById("infoPanelContainer").setAttribute("style", "border:1px;background-color:#808000;color:white;border-radius:5px;");
